...
const Card = ({ gameName,studioName, categories, backgroundImage, price, Description, releaseDate, category, steam, epic, gog, cpu, gpu, ram, review, userImage, userReview, image1, image2, image3, trailer }) => {
  return (
